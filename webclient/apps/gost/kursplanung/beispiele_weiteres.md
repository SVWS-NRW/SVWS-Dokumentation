...
+ Einige **LKs** wurden in Schienen **fixiert** (schwarze Pinnadeln).
...
Der Haken des Wunschergebnisses (und eventuell die Startvorlage) können entfernt werden. Dann können alle anderen Ergbnisse auf einmal gelöscht werden.
...
![Beispiel1-Sport 1](./graphics/SVWS_Oberstufe_Kursplanung_Sport-1.png "Leeren Sie erst den Kurs, da die automatisch zugewiesenen Schüler eventuell nicht die sind, die Sie im Kurs einteilen möchten.")
...
Grundsätzlich können sogenannte **Mehrfachkurse** angelegt werden, die über mehrere Schienen gehen.
...
Die Voraussetzung, um einen Mehrfachkurs anzulegen ist, dass es in der gewählten **Blockung** nur ein einziges **Ergebnis** gibt.
...
In **Oberstufe -> Kursplanung** erscheint die Abwahl des Faches als roter Hinweis unter **Ungültige Kurszuordnungen**.
...
Es empfiehlt sich, mögliche Umwahlen von feststehenden Wiederholern noch vor dem Schuljahreswechsel abzufragen, um die Umwahl auch in der neuen Blockung sicherzustellen und die Laufbahnen schon beim Blocken sauber zu verarbeiten.
:::
