...
Unter den **Grunddaten** eines jeden Stundeplans lässt sich seine **Bezeichnung** und der Gültigkeitssbereich mit **Gültig ab** und **Gültig bis** einstellen.
...
* *AB-Wochen*, *ABC-Wochen* oder *ABCD-Wochen* für entsprechend zwei-, drei- oder vierwöchigen Wechsel.
...
Wird ein Wechselwochenmodell gewählt, lassen sich auch die **Kalenderwochen** wählen, jeweils mit der *KW* und ihrem Datumsbereich und welcher *Wochentyp* - also A, B, C usw. - für diese KW gelten soll. Somit sind auch unregelmäßige Muster einstellbar.
...
Der aktuell gewählte Abschnitt ist mit einem Haken ✓ markiert, der aktuelle Lernabschnitt der Schule ist **fett** hinterlegt.
...
Sind die grundsätzlichen Einstellungen vorhanden, wird ein kompletter Stundenplan über **Datenaustausch Untis** eingelesen und einem definierten Stundenplan zugewiesen.
...
Lesen Sie für die detaillierte Erklärung bitte **Anleitungen ➜ Stundenpläne**.
