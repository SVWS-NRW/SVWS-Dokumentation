...
![Gruppenprozessmodus aktiviert, speichern, zurücksetzen oder beenden](./graphics/svws_gruppenprozesse_speichern.png "Sie können den Gruppenprozess abschließen, zurücksetzen oder abbrechen.")

Ist der Modus für die Mehrfachauswahl aktiviert, können Sie im Kopf sehen, welche Schüler aktiviert sind. Weiterhin ist direkt im Kopf die Option gegeben, den Modus mit **Auswahl aufheben** direkt zu verlassen.
...
![Wählen Sie, welche Informationen verändert werden sollen](./graphics/svws_gruppenprozesse_wahlen.png "Wählen Sie aus, welche Informationen bei den gewählten Schülern verändert werden sollen.")
...
![Informationsfenster mit den Anzahlen](./graphics/svws_gruppenprozesse_informationen.png "Es werden die Anzahlen vor und nach der Änderung zusammengefasst.")
