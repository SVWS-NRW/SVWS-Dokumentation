...
Die Datei kann über eine von der jeweiligen Schule zur Verfügung gestellten Webseite geöffnet werden. Ein Testserver ist unter [weblupo.svws-nrw.de](https://weblupo.svws-nrw.de) verfügbar.
...
Ebenso sind *Unzulässige Kombinationen* anzulegen, etwa, wenn sich bestimmte Kurse an Ihrer Schule gegenseitig ausschließen. Ähnlich sind *Geforderte Kombinationen* zu konfigurieren, wenn diese etwa durch Profile vorgeschrieben werden.

Hierbei ist zu beachten: Konfigurieren Sie so wenig wie möglich, die allgemeinen Rahmenbedingungen, die durch die APO-GoST vorgegeben werden, sind schon im WebClient hinterlegt.
