...
![Eintragen von Leistungsdaten für eine Lerngruppe](./graphics/svws_gradehub_leistungsdaten.png "Hier im Beispiel werden Noten eingetragen.")
...
![Speichern Sie Ihre Änderungen](./graphics/svws_gradehub_leistungsdaten_speichern.png "Sie müssen Ihre Änderungen speichern!")
...
![Änderungen sind grün markiert](./graphics/svws_gradehub_leistungsdaten_aenderungen_gruen.png "Änderungen zu vorherigen Einträgen sind grün hervorgehoben.")
...
![Fachbezogene Fehlstunden erfassen](./graphics/svws_gradehub_leistungsdaten_fsf.png "Erfassen Sie fachbezogene Fehlstunden, indem Sie den Schalter aktivieren.")
...
![Fachbezogene Bemerkungen](./graphics/svws_gradehub_leistungsdaten_fachbezogene_bemerkungen.png "Tragen Sie fachbezogene Bemerkungen als Freitext oder über den Floskeleditor ein.")
...
![Floskeln speichern, verwerfen, Editor verlassen](./graphics/svws_gradehub_floskeln_speichern.png "Verwerfen oder Übernehmen Sie Eintragungen.")

Unten links können Sie zu einem vorherigen oder nächsten Schülereintrag wechseln.

![Bedienelemente zum Vor- und Zurückwechseln](./graphics/svws_gradehub_floskeln_vorzurueck.png "Wechseln Sie zu vorherigen und folgenden Schülerinneneinträgen.")
...
![Kacheln für die Klassenleitung](./graphics/svws_gradehub_leistungsdaten_klassenleitung.png "Tragen Sie Daten als Klassenleitung ein.")

Es öffnet sich die Klassenleitungs-Übersicht:

![Klassenleitungs-Übersicht](./graphics/svws_gradehub_klassenleitung_daten.png "Geben Sie Daten ein, die über eine Klassenleitung erfasst werden.")
...
![Zusammenfassung vor dem Speichern](./graphics/svws_gradehub_speichern_zusammenfassung.png "Im Speichern-Dialog erhalten Sie eine Übersicht der Änderungen.")
...
![Nachfrage des Browsers](./graphics/svws_gradehub_speichern_browserfrage.png "Es öffnet sich möglicherweise eine Nachfrage des Browers. Wir bestätigen mit OK.")
...
![Dateispeicherort wählen](./graphics/svws_gradehub_speichern_speicherort.png "Hier wird die originale Lehrkraft-Notendatei wieder überschrieben.")
