...
### Fall 1:
Je nach Schulform verlassen nach dem Jahrgang 10 die meistens noch schulplfichtigen Schülerinnen und Schüler die Schule. Diese müssen für Schulbewerbung.de im WebClient "markiert" werden. In der **App Schule** gibt es unter Datenaustausch den Menüpunkt **Schulbewerbung.de**, den man mit entsprechender Berechtigung aufrufen kann.
...
Der Benutzer kann dann die gewünschten Importdaten markieren und in die Datenbank übernehmen. Diese werden mit dem Status "Neuaufnahme" in den gewünschten Container importiert.
