...
Für eine ausführliche Anleitung zur **Noteneingabe** konsultieren Sie bitte das [Benutzerhandbuch SVWS-WeNoM](../../../../svws-wenom/index.md).
:::
...
![Filtern Sie auf Lerngruppen](./graphics/svws_noten_lerngruppenfilter.png "Filtern Sie auf Ihre Lerngruppen und wählen Sie diese dann aus..." )

Nachdem Sie auf Lerngruppen gefiltert haben, hier im Beispiel auf welche der Klasse `09a`, können Sie diese auswählen:

![Anwahl von Deutsch](./graphics/svws_noteneingabe_deutsch.png "Hier im Beispiel wird das Fach Deutsch durhc einen Klick aktiviert.")
...
![Klassenleitungseingaben](./graphics/svws_noteneingabe_klassenleitung.png "Geben Sie als Klassenleitung Fehlstunden und Bemerkungen ein.")
...
![Floskeleditor](./graphics/svws_noteneingabe_bemerkungen_floskeleditor.png "Verwenden Sie den Floskeleditor, um diese einer Person zuzuordenen.")
