...
Im Beispiel oben sind die Fächer *ER* und *KR* im gewählten *Abiturjahrgang 2025*, der im aktuellen Schuljahr der Datenbank die *Q1* ist, zwar durchgehend belegt, sie stehen aber nicht als LK zur Wahl.
...
Zum Beispiel könnte bei einem sprachlichen Profil ein Deutsch-LK zwangsläufig an den Englisch-LK gekoppelt sein oder bei einem biochemischen Profil könnte das Belegen eines Bio-LKs auch das belegen eines Chemie-GKs erfordern.
