...
Grundsätzlich werden alle Bereiche des SVWS-Clients oder von SchILD-NRW 3 in deren Dokumenationen beschrieben. Hier werden die Informationen bei Bedarf knapp doppelt aufgenommen, so dass die Oberstufenkoordination in diesem Handbuch nahtlos abgedeckt wird.

Weitere Details sind den speziellen Artikeln zu entnehmen, die über das Inhaltsverzeichnis erreicht werden können.
...
Ebenso kann hier eine Bearbeitung notwendig werden, wenn sich die rechtlichen oder pädagogischen Rahmenbedingungen ändern, wenn also neue Fächer vorgesehen sind oder sich deren Statistikbezeichnungen ändern oder an Ihrer Schule ein neues Fach angeboten wird.

Hier stellen Sie auch die vorhandenen Jahrgänge und Klassen mit den Restabschnitten ein.
...
Im Anschluss an diese allgemeine Einstellung wird für jeden Abiturjahrgang festgelegt, welche Rahmenbedinungen dort im Allgemeinen gelten: Vielleicht gab as in einem Abiturjahrgang den Projektkurs "Tolles Bio-Projekt!" (PJBio), aber im nächsten Abiturjahrgang wird dieser nicht angeboten, dafür aber eventuell ein "Großartiges Erziehungswissenschaft-Physik-Projekt" (PJEP).
...
Das heißt, es muss geplant werden, welche Kurse konkret angeboten werden und welche von idesen Kursen parallel liegen. Bieten Sie drei Chemie-GKs an? Muss einer davon parallel zu "Spanisch (Neueinsetzend)" liegen, um alle Schülerwahlen auch ermöglichen können?

Ebenso lassen sich in den Kursen Plätze für Externe Schülerinnen einstellen, um Kooperationen mit anderen Schulen abbilden zu können.

An dieser Stelle ist eventuell eine Rückkopplung mit dem vorherigen Kapitel notwendig, beziehungsweise muss im vorherigen Kapitel schon an die Blockung gedacht werden und Schüler müssen so beraten werden, dass sich eine Blockung erstellen lässt, in der alle Laufbahnwahlen wie beraten abgebildet sind.
...
Dieses Kapitel deckt diese Punkte ab und bespricht das Drucken der jeweiligen Formulare. Ebenso wird die Installation der aktuellen Zeugnisanlagen behandelt.
