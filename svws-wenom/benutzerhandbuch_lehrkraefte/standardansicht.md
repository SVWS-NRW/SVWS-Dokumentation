...
Möchten Sie direkt mehrere Lerngruppen untereinander rechts im Fenster anzeigen lassen, so klicken Sie links auf die jeweiligen Kästchen der darzustellenden Fächer und Klassen.
...
Möchten Sie gerne weniger Elemente darstellen, so deaktivieren Sie die entsprechenden Elemente. Sie können dies selbst steuern.
